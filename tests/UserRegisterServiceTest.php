...
class UserRegisterServiceTest extends DbTestCase
{
	 ...
	 * @group test
	 */
	public function getArrayFieldToSendTest()
	{
		$faker = Factory::create();
		$input = ['email' => $faker->email,'name'=>$faker->name,'credit_card'=>$faker->creditCardNumber];
		$result = $this->userRegisterService->getArrayFieldToSend($input);
