    ...
    <div class="login-panel panel panel-default">
      ...
      <div class="panel-body">
        ...
        <fieldset>
          ...
          <div class="form-group">
            <input class="form-control" placeholder="First name" name="first_name" type="text" autofocus autocomplete="off">
            {{--<span class="text-danger">{{$errors->first('first_name')}}</span>--}}

          </div>
          <div class="form-group">
            <input class="form-control" placeholder="Last name" name="last_name" type="text" value="" autocomplete="off">
