    ...
    {{Form::model($user_profile,['route'=>'users.profile.edit', 'method' => 'post'])}}
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                {{FormField::company(["label" => "Ragione sociale:"])}}
                ...
                {{FormField::billing_city(["label" => "Città fatturazione"])}}
                ...
                {{FormField::billing_state(["label" => "Provincia fatturazione"])}}
                <span class="text-danger">{{$errors->first('billing_state')}}</span>
                {{FormField::billing_country(["label" => "Nazione fatturazione"])}}
            ...
            <div class="col-md-6">
                ...
                {{FormField::shipping_city(["label" => "Città spedizione"])}}
                ...
                {{FormField::shipping_state(["label" => "Provincia spedizione"])}}
                <span class="text-danger">{{$errors->first('shipping_state')}}</span>
                {{FormField::shipping_country(["label" => "Nazione spedizione"])}}
